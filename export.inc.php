...
function export_wp( $args = array() ) {
	...
	$filename = 'virtusjustitita-authorbackup-' . date( 'Ymd-His' ) . '.xml';
	...
	function wxr_authors_list() {
		...
		$authors = array();
		$results = $wpdb->get_results( "SELECT DISTINCT post_author FROM $wpdb->posts WHERE post_status != 'auto-draft' AND post_author = ".get_current_user_id() );
